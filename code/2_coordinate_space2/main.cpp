...
int main () {
  ...
  // 垂直方向满屏时的 z：-0.5f - 0.5f / tan(M_PI / 8)
  glm::vec3 cubePositions[] = {
    glm::vec3( 0.0f,  0.0f,  -3.0f), 
    glm::vec3( 2.0f,  5.0f, -19.0f), 
    glm::vec3(-1.5f, -2.2f, -6.5f),  
    glm::vec3(-3.8f, -2.0f, -16.3f),  
    glm::vec3( 2.4f, -0.4f, -7.5f),  
    glm::vec3(-1.7f,  3.0f, -13.5f),  
    glm::vec3( 1.3f, -2.0f, -8.5f),  
    glm::vec3( 1.5f,  2.0f, -8.5f), 
    glm::vec3( 1.5f,  0.2f, -7.5f), 
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    for (int i = 0; i < 10; i++)
    {
      glm::mat4 model;
      if (i % 3) {
        model = glm::rotate(trans, glm::radians(20.0f * i), glm::vec3(0.5f, 1.0f, 0.0f));
      } else {
        model = glm::rotate(trans, (float)(glfwGetTime() * glm::radians(50.0f * i + 5)), glm::vec3(1.0f, 0.5f, 0.1f));
      }
      glm::mat4 view = glm::translate(trans, cubePositions[i]);
